...
#ifndef USAGE_MONITOR_RTC_CLOCK_H
#define USAGE_MONITOR_RTC_CLOCK_H

#include <Arduino.h>
#include <time.h>

struct UsageMonitorRtcTime {
  int year;
  int month;
  int day;
  int weekday;
...
class RtcClock {
 public:
  ...
  bool readTime(UsageMonitorRtcTime& out);
  time_t nowEpoch();
  String nowTimeLabel();
  String nowDateLabel();
...
#endif  // USAGE_MONITOR_RTC_CLOCK_H
